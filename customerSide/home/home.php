    ...
    <div class="nav-bar">
      <div class="brand">
          <a class="nav-link" href="../home/home.php#hero">
            <h1 class="text-center" style="font-family:Copperplate; color:whitesmoke;"> CHIYA FACTORY</h1><span class="sr-only"></span>
            </a>
...
<section id="hero" style="position: relative;">
    <video autoplay loop muted playsinline poster="your-poster-image.jpg" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover;">
        <source src="../image/bgvidd.mp4" type="video/mp4">
    ...
    <div class="hero container" style="position: relative; z-index: 1;">
        <div>
            <h1><strong><h1 class="text-center" style="font-family:Copperplate; color:whitesmoke;"> CHIYA FACTORY</h1><span></span></strong></h1>
            <h1><strong style="color:white;">Garden Cafe & Restaurant<span></span></strong></h1>
...
<!-- End Hero Section -->
  ...
  <!-- About Section -->
   ...
   <div class="elfsight-app-db52a555-0423-4290-9c08-4fb01e1f6697" data-elfsight-app-lazy></div>
    ...
    <div class="contact-items">
      <div class="contact-item contact-item-bg">
        <div class="contact-info">
          ...
          <h1>Phone</h1>
          <h2>+977-9869748333, +977-9862585652</h2>
        </div>
      </div>
      ...
      <div class="contact-item contact-item-bg">
        <div class="contact-info">
          ...
          <a href="https://maps.app.goo.gl/JAPSiZ6C2dvBJbtZA" class="label-2 footer-link hover-underline"><h1>Address</h1></a>
          <h2>Kirtipur-9, Chhugaun</h2>
        </div>
      </div>
    </div>
  </div>
...
<!-- End Contact Section -->
  ...
  <section id="footer">
    <div class="footer container">
        <div class="brand">
          <h1>Your Favourite Hangout Spot</h1>
      </div>
        <h2>Follow our Socials</h2>
      <div class="social-icon">
        <div class="social-item">
          <a href="https://www.facebook.com/profile.php?id=61557794771152"><img src="https://img.icons8.com/color/48/facebook.png" alt="facebook"/></a>
        </div>
        <div class="social-item">
          <a href="https://www.instagram.com/chiyafactory?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="><img src="https://img.icons8.com/color/48/instagram-new.png" alt="instagram-new"/></a>
        </div>
          <div class="social-item">
